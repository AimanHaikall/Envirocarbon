...
//	
//	@RequestMapping("/home")
//	public ModelAndView recycleHome(HttpServletRequest request) {
//	    ModelAndView model = new ModelAndView("recycle");
//
//	    // Retrieve the HttpSession object from the HttpServletRequest
//	    HttpSession session = request.getSession();
//
//	    // Get the current user using the UserDAO
//	    User user = userDAO.getCurrentUser(session);
//
