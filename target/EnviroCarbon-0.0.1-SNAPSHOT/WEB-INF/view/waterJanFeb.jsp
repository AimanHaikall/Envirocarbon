        ...
        <!-- Add a submit button -->
                  ...
                  <div class="row mb-4">
                    <div class="col-sm-6 col-lg-6">
                      <div>
                          <div class="card-header position-relative d-flex justify-content-center align-items-center">
                              <label for="waterJanuary" class="form-label"><h4>3. Current water consumption values (m3) in January:</h4></label>
                          </div>
                          <div class="card-body row text-center">
                              <div class="col">
                                  <input type="text" id="waterJanuary" name="waterJanuary" class="form-control" required>
                              </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="col-sm-6 col-lg-6">
                      <div>
                          <div class="card-header position-relative d-flex justify-content-center align-items-center">
                              <label for="waterFebruary" class="form-label"><h4>8. Current water consumption values (m3) in February:</h4></label>
                          </div>
                          <div class="card-body row text-center">
                              <div class="col">
                                  <input type="text" id="waterFebruary" name="waterFebruary" class="form-control" required>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    <div class="col-sm-6 col-lg-6">
                      <div>
                          <div class="card-header position-relative d-flex justify-content-center align-items-center">
                              <label for="waterCJanuary" class="form-label"><h4>4. Current water consumption values (RM) in January</h4></label>
                          </div>
                          <div class="card-body row text-center">
                              <div class="col">
                                  <input type="text" id="waterCJanuary" name="waterCJanuary" class="form-control" required>
                              </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="col-sm-6 col-lg-6">
                      <div>
                          <div class="card-header position-relative d-flex justify-content-center align-items-center">
                              <label for="waterCFebruary" class="form-label"><h4 >9. Current water consumption values (RM) in February</h4></label>
                          </div>
                          <div class="card-body row text-center">
                              <div class="col">
                                  <input type="text" id="waterCFebruary" name="waterCFebruary" class="form-control" required>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="text-end mt-3">
                    <a href="water.jsp" class="btn btn-secondary">Back</a>
                    <a href="waterMarApr.jsp" class="btn btn-primary">Next Page</a>
                </div>
                  </div>
