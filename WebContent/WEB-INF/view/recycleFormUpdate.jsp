	...
	<div class="wrapper d-flex flex-column min-vh-100 bg-light">
		...
		<div class="body flex-grow-1 px-3">
			<div class="container-lg">
				<form
					action="${pageContext.request.contextPath}/recycle/update/${recycle.id}"
					method="post">
					...
					<div class="row mb-4" style="margin-top: 20px;">
						<div>
							<label for="month" class="form-label">Month:</label> <input
								type="month" id="month" value="${recycle.month}" name="month"
								required>
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-sm-6 col-lg-6">
							<div>
								<div
									...
									<label for="weightKg" class="form-label"><h4>3.
											Current Recycle weight values (Kg):</h4></label>
								</div>
								<div class="card-body row text-center">
									<div class="col">
										<input type="text" id="weightKg" name="weightKg"
											value="${recycle.weightKg}" class="form-control" required>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-6">
							<div>
								<div
									class="card-header position-relative d-flex justify-content-center align-items-center">
									<label for="weightRm" class="form-label"><h4>4.
											Current Recycle weight values (RM)</h4></label>
								</div>
								<div class="card-body row text-center">
									<div class="col">
										<input type="text" id="weightRm" name="weightRm"
											value="${recycle.weightRm }" class="form-control" required>
									</div>
								</div>
							</div>
						</div>
