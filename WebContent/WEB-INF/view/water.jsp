                ...
                <div class="container-lg " >
                    <div class="table-responsive " style="background-color: white;">
                            ...
                            <tr class="align-middle" style="font-weight: bold">
                              ...
                              <td >
                                <div>
                        			...
                        			<a href="<c:url value='/water/delete/${record.id}'/>" class="btn btn-danger" onclick="confirm('Confirm delete?')">Delete</a>
                    			</div>
                              </td>
                      ...
                      <div class="text-end mt-3">
                        ...
                        <a href="/EnviroCarbon/submission/calculateWater" class="btn btn-primary">Submit</a>
                    </div>
