	...
	<div class="wrapper d-flex flex-column min-vh-100 bg-light">
		...
		<div class="body flex-grow-1 px-3">
			<div class="container-lg">
				<form action="<c:url value='/recycle/add'/>" method="post">
						...
						<div class="col-sm-6 col-lg-6">
							<div>
								<div
									...
									<label for="weightKg" class="form-label"><h4>1. Current
											recycle weight values (kg) :</h4></label>
								</div>
					...
					<div class="row mb-4">
						<div class="col-sm-6 col-lg-6">
							<div>
								...
								<div class="card-body row text-center">
									<div class="col">
										<input type="text" id="weightRm" name="weightRm" class="form-control"
											required>
									</div>
								</div>
							</div>
