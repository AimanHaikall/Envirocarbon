					...
					<div class="row mb-4" style="margin-top: 20px;">
						...
						<div class="col-sm-6 col-lg-6">
							<div>
								<div
									...
									<label for="days" class="form-label"><h4>1. Number
											of Days:</h4></label>
								</div>
						...
						<div class="col-sm-6 col-lg-6">
							<div>
								<div
									class="card-header position-relative d-flex justify-content-center align-items-center">
									<label for="prorated" class="form-label"><h4>2.
											Prorated factor:</h4></label>
								</div>
								<div class="card-body row text-center">
									<div class="col">
										<input type="text" id="prorated" name="prorated"
					...
					<div class="row mb-4">
						<div class="col-sm-6 col-lg-6">
							<div>
								<div
									class="card-header position-relative d-flex justify-content-center align-items-center">
									<label for="kwh" class="form-label"><h4>3. Current
											Electric consumption values (kWh):</h4></label>
								</div>
								<div class="card-body row text-center">
									<div class="col">
						...
						<div class="col-sm-6 col-lg-6">
							<div>
								<div
									class="card-header position-relative d-flex justify-content-center align-items-center">
									<label for="rm" class="form-label"><h4>4. Current
											electric consumption values (RM)</h4></label>
								</div>
								<div class="card-body row text-center">
									<div class="col">
